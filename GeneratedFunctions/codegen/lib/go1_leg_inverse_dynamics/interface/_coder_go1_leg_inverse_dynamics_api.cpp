...
//
// _coder_go1_leg_inverse_dynamics_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "go1_leg_inverse_dynamics",                           // fFunctionName
                                     ...
                                     const mxArray **plhs)
{
  ...
  go1_FL_leg_inverse_dynamics(*in1, *in2, *in3, *taulist);
                                     ...
                                     const mxArray **plhs)
{
  ...
  in3 = emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "in3");
  // Invoke the target function
  go1_FR_leg_inverse_dynamics(*in1, *in2, *in3, *taulist);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*taulist);
}
                                     ...
                                     const mxArray **plhs)
{
  ...
  in3 = emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "in3");
  // Invoke the target function
  go1_RL_leg_inverse_dynamics(*in1, *in2, *in3, *taulist);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*taulist);
}
                                     ...
                                     const mxArray **plhs)
{
  ...
  in3 = emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "in3");
  // Invoke the target function
  go1_RR_leg_inverse_dynamics(*in1, *in2, *in3, *taulist);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(*taulist);
}
...
void go1_leg_inverse_dynamics_atexit()
{
  ...
  go1_leg_inverse_dynamics_xil_terminate();
  go1_leg_inverse_dynamics_xil_shutdown();
...
// End of code generation (_coder_go1_leg_inverse_dynamics_api.cpp)
