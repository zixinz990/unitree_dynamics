...
void go1_FR_leg_inverse_dynamics(const double in1[3], const double in2[3],
                                 const double in3[3], double taulist[3])
{
  ...
  t296 = in2[0] * in2[1];
  t32 = t296 * in1[1] * t13 * t22;
  t82 = in2[0] * in1[1];
  t43 = t82 * in1[2] * t13 * t14 * t22 * t24;
  t85_tmp = t82 * t13 * t22;
  t85 = t85_tmp * 0.033451;
  t96_tmp = in1[0] * std::sin(t5) * t20;
  ...
  t98 = t36 * 0.016646;
  t186 = in2[1] * 0.033451 - t85_tmp * 0.063146;
  ...
  t231 = (in2[1] * 0.004485671726 + t85_tmp * 0.000572001265) +
         t56_tmp * 5.7496807E-5;
  t234 = (in2[1] * 5.7496807E-5 - t85_tmp * 0.000218457134) +
  ...
  t192_tmp = in2[2] * t120;
  t194 = t72 * t120;
  t228_tmp = in2[1] * (t85 + t113);
  t232 = (in2[1] * 0.000572001265 + t85_tmp * 0.000740309489) -
  ...
  t25 = ((in3[1] * 0.003342 + t32 * 0.063146) + t135) - t168;
  t14 = in2[1] * t249;
  t11 = t16 * t22 * t35_tmp;
  ...
  t224 = in2[1] * t222;
  t238 = t65 + t222;
  t240 = (t56_tmp * 0.00805184 + in2[1] * 0.00307464) - t20 * 0.92;
  ...
  t5 = (t36 + 1.0) * t238;
  t20 = in2[1] * t251;
  t17 = ((in3[1] * 0.033451 - t31 * 0.07189799999999999) + t110) + t224;
  t296_tmp = t110_tmp * (((t110_tmp * 0.033349 + t35 * 0.002315) +
             ...
             (t35 + 1.0) * (((t110_tmp * 0.002315 - t35 * 0.033349) +
                            ...
                            0.033349);
  t296 = in2[0] * t296_tmp;
  t301_tmp = in3[0] * t296_tmp;
  t291 = t204_tmp * t251 + (t36 + 1.0) * t249;
  t306 = in2[0] * 0.000102 + t296;
  t311 = ((((in2[2] * 0.116695 - t136) - t191) + t212) + t7) + t14;
  t82 = t56_tmp * t291;
  t307 = in2[0] * 9.384E-5 + t296 * 0.92;
  t11 = ((((in2[2] * 0.0061970000000000011 - t114) + t204) + t206) - t5) + t20;
  t314 = ((((in2[1] * 0.0061970000000000011 + t114) - t204) - t206) + t5) - t20;
  t317 =
      ((((t148 - t49 * 0.002261558852) - t191 * 0.135862) + t212 * 0.135862) +
       t7 * 0.135862) +
      t14 * 0.135862;
  t5 = ((((in2[2] * 0.00084193681400000016 - t43 * 0.002261558852) +
          t204 * 0.135862) +
         t206 * 0.135862) -
        t5 * 0.135862) +
       t20 * 0.135862;
  ...
  t20 = (-in2[0] * in1[1] * t13 * t22 * t326_tmp + t82) + t306;
  t320 = t8 * t5;
  t43 = ((in2[0] * 1.3857924E-5 + t85_tmp * t326_tmp * -0.135862) +
         t296 * 0.135862) +
        t82 * 0.135862;
  t13 = -(t311 * t5);
  t22 = t120 * t43;
  t338_tmp = t204_tmp * t185_tmp;
  b_t338_tmp = in3[1] * t249;
  c_t338_tmp = (t36 + 1.0) * t17;
  d_t338_tmp = t204_tmp * t25;
  t338 = (((((((in3[2] * 0.01585441609 + t338_tmp * 0.002261558852) -
         ...
         t22;
  t339_tmp = in3[1] * t251;
  t114 = in2[2] * (((((in2[1] * 0.116695 + t136) + t191) - t212) - t7) - t14);
  t49 = (t36 + 1.0) * t25;
  t204 = t170 * t185_tmp;
  t48 = t204_tmp * t17;
  t56 = (((((((-(in3[2] * 0.00084193681400000016) + t162_tmp * 0.002261558852) +
              t204 * 0.135862) -
             t339_tmp * 0.135862) +
            t49 * 0.135862) -
           t48 * 0.135862) +
  ...
  t6 = (((((((-(t96_tmp * 1.33280622) - in3[0] * 1.3857924E-5) +
             t228_tmp * 0.135862) +
            t273) +
           t301_tmp * -0.135862) +
          t321) +
  ...
  t11 = (t36 + 1.0) * t338;
  taulist[0] =
      ((((((in3[0] * 0.000379294663816248 - t321 * 0.000102) +
         ...
         ((((t7 * -0.000102 - t17 * 1.3857924E-5) -
            t296_tmp *
                (((((in3[0] * -0.000107697924 + t273) + t321) +
                   t228_tmp * 1.055862) -
                  t301_tmp * 1.055862) +
           ...
           (t35 + 1.0) * ((((((in3[1] * -5.7496807E-5 + t31 * 0.000218457134) +
                             ...
                             t41 * 0.004431760472) +
                            t42 * 0.000218457134) +
                           ((((((t24 * 0.016646 + t291 * t6) - in2[1] * t232) +
                               (t36 + 1.0) * t23) +
                              (t98 + 0.016646) * t56) +
                             t238 * t307) -
                            t240 * t306)) +
